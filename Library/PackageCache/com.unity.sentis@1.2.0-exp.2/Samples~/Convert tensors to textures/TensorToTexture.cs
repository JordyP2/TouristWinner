...
public class TensorToTexture : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        using TensorFloat rTensor = TensorFloat.Zeros(new TensorShape(1, 1, 1, 1));
        using TensorFloat rgbaTensor = TensorFloat.Zeros(new TensorShape(1, 4, 1, 1));
        ...
        using TensorFloat rgbaNHWCTensor = TensorFloat.Zeros(new TensorShape(1, 8, 8, 4));
